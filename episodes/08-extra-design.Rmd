...
Note that Day0 always correspond to non-infected samples, and that infected samples are collected on days 4 and 8.
...
Based on this visualization, would you say that the data set is balanced, or are there combinations of predictor variables that are severaly underrepresented?
