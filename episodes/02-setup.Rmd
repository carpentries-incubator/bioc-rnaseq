...
- What is the best way to set up directories for an analysis?
- How to download data set from Gene Expression Omnibus (GEO)?

::::::::::::::::::::::::::::::::::::::::::::::::

::::::::::::::::::::::::::::::::::::: objectives

- Create an RStudio project and the directories required for an analysis.
...
for writing and running R code. 
Additionally, we will leverage RStudio projects, a feature built-in to RStudio for managing our analysis project.
If you require assistance with RStudio or its general usage, please refer to our
[Introduction to data analysis with R and Bioconductor](https://carpentries-incubator.github.io/bioc-intro/20-r-rstudio.html#how-to-learn-more-during-and-after-the-course)
lesson.
